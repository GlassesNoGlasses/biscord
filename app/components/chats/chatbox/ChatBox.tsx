...
export const ChatBox = ({
  ...
  return (
    <div className='flex w-full p-4 h-fit flex-row align-middle justify-center gap-3'>
        <input
        type='file'
        ...
        <label htmlFor='chatbox-file-input' className='flex bg-slate-700 hover:brightness-110 rounded-lg border-2 border-gray-400 h-full w-fit'>
